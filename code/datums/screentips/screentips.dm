#define HINT_ICON_FILE 'modular_exostation/local_fixes/icons/cursor_hints.dmi' // EXOSTATION EDIT : BASE_CONFIG : screentips temp fix. Original : 'icons/ui/screentips/cursor_hints.dmi'
