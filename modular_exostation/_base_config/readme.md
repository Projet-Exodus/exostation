...
- `tools\ci\check_grep.sh` : ajouts de `modular_exostation/**` et de `code modular_exostation`
- `tools\ticked_file_enforcement\schemas\tgstation_dme.json` : ajouts de `"modular_exostation/*.dm"` et `"modular_exostation/**/*.dm"`
- `tools\define_sanity\check.py` : ajouts de `"modular_exostation/*.dm"` et `"modular_exostation/**/*.dm"`
