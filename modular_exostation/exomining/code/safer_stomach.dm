...
/datum/element/safer_stomach/Detach(mob/living/source, ...)
	. = ..()
	source.remove_status_effect(/datum/status_effect/grouped/stasis, STASIS_SOURCE_EATEN)
	UnregisterSignal(source, COMSIG_MOVABLE_MOVED)

/// Remove the stasis effect
/datum/element/safer_stomach/proc/on_rescued(mob/living/rescued)
	SIGNAL_HANDLER
	if (regenerative_stomach)
	...
	rescued.RemoveElement(/datum/element/safer_stomach, regenerative_stomach = regenerative_stomach)
