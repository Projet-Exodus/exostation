...
export type LoadoutList = { loadouts: string[]; loadout: LoadoutListInfo }; // EXOSTATION EDIT CHANGE - CHAR_LOADOUT : Multiple loadout presets: ORIGINAL: export type LoadoutList = Record<typePath, LoadoutListInfo>;
