...
import '../../styles/interfaces/ExoNanoMap.scss';
...
function NanoMapPreferences(props) {
  ...
  const cannotSetPrefText = minimapDisabled
    ? 'Sur cette interface, vous ne pouvez pas modifier les paramètres de la mini-carte et son état.'
    : undefined;
  ...
  return (
    <Modal p={0.5}>
      ...
      >
        <LabeledList>
          <LabeledList.Item label="Position sur la mini-carte">
            <Stack wrap width={5}>
          ...
          <LabeledList.Item label="Mini-carte">
            <Button.Checkbox
